  ...
  try {
    ...
    const newProduct = await prisma.product.create({
      data: {
        ...
        pro_low_stock: body.pro_low_stock !== undefined && body.pro_low_stock !== '' ? parseInt(body.pro_low_stock) : null,
...
export async function PUT(request) {
  try {
    ...
    const updateData = {
      ...
      pro_low_stock: body.pro_low_stock !== undefined ? parseInt(body.pro_low_stock) : undefined,
